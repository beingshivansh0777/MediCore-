  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl font-serif mx-auto min-h-screen bg-linear-to-b from-green-50 via-white to-white">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-linear-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent mt-2 sm:mt-0">
            Add New Doctor
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm border border-emerald-100 shadow-2xl p-6 sm:p-8 rounded-3xl mb-16">
        ...
        >
          <div className="md:col-span-2">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <input
                ...
                className="block w-full max-w-full md:w-auto md:max-w-xs border border-emerald-300 rounded-full px-4 py-2 text-sm bg-white cursor-pointer file:bg-emerald-50 file:border-0 file:px-4 file:py-1 file:rounded-full file:text-emerald-700 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-200 transition"
              />
              {form.imagePreview && (
                <div className="relative group">
                  ...
                  <button
                    type="button"
                    onClick={removeImage}
                    className="absolute -top-2 -right-1.5 bg-rose-500 text-white rounded-full p-1 transition cursor-pointer"
                  >
                    <XCircle size={14} />
                  </button>
                </div>
          ...
          <div className="relative">
            <input
              className="p-3 rounded-full border-2 border-emerald-100 bg-white placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all pr-12"
          ...
          <textarea
            ...
            className="p-3 rounded-xl border-2 border-emerald-100 bg-white placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all md:col-span-2"
            value={form.about}
            onChange={(e) =>
              setForm({
                ...form,
    ...
    ${
      loading
        ...
        : "bg-linear-to-r from-emerald-500 to-cyan-500 text-white cursor-pointer"
    }`}
            >
